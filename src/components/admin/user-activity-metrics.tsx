      ...
      try {
        ...
        const { count: previousMonthUsers } = await supabase
          ...
          .gte(
            'created_at',
            new Date(
              oneMonthAgo.getTime() - 30 * 24 * 60 * 60 * 1000
            ).toISOString()
          )
        ...
        const retentionRate = previousMonthUsers
          ? ((retainedUsers || 0) / previousMonthUsers) * 100
          : 0
        ...
        const averageSessionTime = sessions?.length
