...
export function SecurityManager({ videoId, currentSecurity, onUpdate, loading }: SecurityManagerProps) {
  const [security, setSecurity] = useState<ContentSecurity['privacy']>(currentSecurity || {
    view: 'disable',
    embed: 'private',
    comments: 'nobody',
    download: false,
  ...
  const handleChange = <K extends keyof ContentSecurity['privacy']>(field: K, value: ContentSecurity['privacy'][K]) => {
      ...
      <div className="space-y-2">
        <div>
          ...
          <select
            id="view-privacy"
            value={security.view}
            onChange={(e) => handleChange('view', e.target.value as ContentSecurity['privacy']['view'])}
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleChange('embed', e.target.value as ContentSecurity['privacy']['embed'])}
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleChange('comments', e.target.value as ContentSecurity['privacy']['comments'])}
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
