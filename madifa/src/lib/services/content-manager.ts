...
class ContentManager {
  ...
  async getContent(filters?: ContentFilters, sort?: ContentSort): Promise<Content[]> {
  ...
  async addToPlaylist(playlistId: string, contentId: string, position?: number): Promise<void> {
  ...
  async addToSeries(seriesId: string, contentId: string, episodeNumber: number): Promise<void> {
  ...
  async updateMetadata(contentId: string, metadata: Partial<ContentMetadata>): Promise<void> {
    const { error } = await supabase
